...
public class ConstantesIdsFormularios {
        ...
        public static int[] arraysIdsMenuLateralCaranguejo = {

                R.id.localizacao_residencia_entrevistado,

                R.id.identificacao_entrevistado,

                R.id.b1_q1, R.id.b1_q2, R.id.b1_q3,R.id.b1_q4,R.id.b1_q5,R.id.b1_q6,R.id.b1_q7, R.id.b1_q8,R.id.b1_q9,R.id.b1_q10,R.id.b1_q11,R.id.b1_q12, R.id.b1_q13,R.id.b1_q14,R.id.b1_q15,

                R.id.b2_q1, R.id.b2_q2, R.id.b2_q3,R.id.b2_q4,R.id.b2_q5,R.id.b2_q6,

                R.id.b3_q1, R.id.b3_q2, R.id.b3_q3,R.id.b3_q4,R.id.b3_q5,R.id.b3_q6,R.id.b3_q7, R.id.b3_q8,R.id.b3_q9,
                ...
                R.id.b6_q1, R.id.b6_q2, R.id.b6_q3, R.id.b6_q4, R.id.b6_q5, R.id.b6_q6, R.id.b6_q7, R.id.b6_q8,

                R.id.b7_q1, R.id.b7_q2, R.id.b7_q3,R.id.b7_q4,R.id.b7_q5 ,R.id.b7_q6,R.id.b7_q7, R.id.b7_q8,R.id.b7_q9,R.id.b7_q10,R.id.b7_q11,R.id.b7_q12,R.id.b7_q13,
        ...
        public static int[] arrayIdsFormularioCaranguejo = {
                R.layout.localizacao_residencia_form,

                R.layout.identificacao_entrevistado_form,

                R.layout.fcmr_reg_b1_q1,R.layout.fcmr_reg_b1_q2, R.layout.fcmr_reg_b1_q3, R.layout.fcmr_reg_b1_q4,
                R.layout.fcmr_reg_b1_q5,R.layout.fcmr_reg_b1_q6, R.layout.fcmr_reg_b1_q7,R.layout.fcmr_reg_b1_q8,
      ...
      public static int[] arraysIdsMenuLateralPiticaiaEBranco = {
            ...
            R.id.b4_q1, R.id.b4_q2, R.id.b4_q3, R.id.b4_q4, R.id.b4_q5, R.id.b4_q6, R.id.b4_q7, R.id.b4_q8, R.id.b4_q9, R.id.b4_q10, R.id.b4_q11,
              ...
              R.id.b6_q1, R.id.b6_q2, R.id.b6_q3, R.id.b6_q4, R.id.b6_q5, R.id.b6_q6,
      ...
      public static int[] arrayIdsFormularioPiticaiaEBranco = {
            R.layout.localizacao_residencia_form,
        ...
        public static int[] arraysIdsMenuLateralCamaraoRegional = {
        ...
        public static int[] arrayIdsFormularioCamaraoRegional = {
                R.layout.localizacao_residencia_form,
